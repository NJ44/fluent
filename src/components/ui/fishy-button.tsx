...
`}</style>
      <style>{`
.button--1 { --color_1:#365fa8;--color_2:#4a76c5;--color_3:#5f8ce2;--color_4:#73a3ff;--color_5:#21488b;--color_6:#132a52; }
.button--2 { --color_1:#0092a0;--color_2:#00afb4;--color_3:#00cbc9;--color_4:#00e7de;--color_5:#00768b;--color_6:#004c59; }
.button--3 { --color_1:#1b70a1;--color_2:#368cc1;--color_3:#50a8e0;--color_4:#6bc4ff;--color_5:#005482;--color_6:#003654; }
.button {
  display:flex;z-index:0;justify-content:center;align-items:center;position:relative;
  width:${width};height:${height};border-radius:${borderRadius};
  text-decoration:none;overflow:hidden;background:var(--color_5);
  box-shadow:0 0 12px rgba(0,0,0,.45),0 0 8px rgba(0,0,0,.25) inset;
  transition:all ease .7s;border:none;cursor:pointer;margin:0 5px;
}
.button::before {
  content:'';position:absolute;z-index:6;top:0;left:0;width:100%;height:100%;
  background:linear-gradient(rgba(0,25,85,0) 60%,rgba(0,25,85,.4));
}
.wave { position:absolute;top:0;left:0;width:100%;height:100%;filter:drop-shadow(0 0 3px rgba(10,60,90,0.8)); }
.wave:nth-child(1){z-index:1}.wave:nth-child(2){z-index:2}.wave:nth-child(3){z-index:3}.wave:nth-child(4){z-index:5}
.wave:nth-child(1)::before,.wave:nth-child(1)::after {
  content:'';position:absolute;width:120px;height:65px;background:var(--color_1);
...
.wave:nth-child(1)::before,.wave:nth-child(2)::before,.wave:nth-child(3)::before,.wave:nth-child(4)::before { transform:rotate(180deg);transition:all ease 4.4s; }
.wave:nth-child(1)::after,.wave:nth-child(2)::after,.wave:nth-child(3)::after,.wave:nth-child(4)::after { transition:all ease 4.4s; }
.wave:nth-child(1)::before{top:-16px;left:-16px}.wave:nth-child(2)::before{top:-20px;left:-20px}
.wave:nth-child(3)::before{top:-20px;left:-20px}.wave:nth-child(4)::before{top:-20px;left:-20px}
.wave:nth-child(1)::after{bottom:-16px;right:-16px}.wave:nth-child(2)::after{bottom:-20px;right:-20px}
.wave:nth-child(3)::after{bottom:-20px;right:-20px}.wave:nth-child(4)::after{bottom:-20px;right:-20px}
.wave:nth-child(2)::before,.wave:nth-child(2)::after {
  content:'';position:absolute;width:139px;height:61px;background:var(--color_2);
...
.wave:nth-child(3)::before,.wave:nth-child(3)::after {
  content:'';position:absolute;width:134px;height:56px;background:var(--color_3);
...
.wave:nth-child(4)::before,.wave:nth-child(4)::after {
  content:'';position:absolute;width:129px;height:47px;background:var(--color_4);
...
.button:hover .wave:nth-child(4)::before{top:-4px;left:-4px}.button:hover .wave:nth-child(4)::after{bottom:-4px;right:-4px}
.fish {
  ...
  background:#fff;opacity:0;transition:opacity 0.3s ease;
}
@keyframes fish {
...
.button .bubble{position:absolute;z-index:7;top:0;width:30px;height:80px}
.button .bubble::before,.button .bubble::after{content:'';position:absolute;bottom:0;border-radius:50%;background:rgba(255,255,255,0)}
.button .bubble:nth-child(6){left:16px}.button .bubble:nth-child(7){left:48px}
.button .bubble:nth-child(8){right:16px}.button .bubble:nth-child(9){right:48px}
...
@keyframes shadow{0%{filter:drop-shadow(0 0 1.5px rgba(10,60,90,0.4))}100%{filter:drop-shadow(0 0 10px rgba(10,60,90,0.35))}}
